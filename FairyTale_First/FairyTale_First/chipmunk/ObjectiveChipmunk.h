/**
	...
	First of all, <a href="http://chipmunk-physics.net">Chipmunk</a> is a 2D rigid body physics library distributed under the MIT license.
	...
	Objective-Chipmunk is part of the Chipmunk Pro package, and you can find more information on the Chipmunk website. <a href="http://chipmunk-physics.net/chipmunkPro.php">Chipmunk-Pro</a>
	
	<h1>Where do I start?</h1>
	
	Probably the best place to start is to by going over some of the <a href="http://chipmunk-physics.net/downloads.php">sample code</a> from the downloads page such as the SimpleObjectiveChipmunk tutorial.
